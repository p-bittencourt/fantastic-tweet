...
export const Post = ({ post }: PostProps) => {
  return (
    <article className="p-2 sm:p-4 border bg-amber-50 border-gray-200 dark:bg-amber-800 dark:border-gray-600 rounded-lg mb-2 sm:mb-4 shadow-sm cursor-pointer">
